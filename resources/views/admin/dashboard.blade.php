                    ...
                    @forelse($recent_users as $user)
                        <div class="px-6 py-4">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    @if ($user->line_avatar)
                                        <img class="h-8 w-8 rounded-full" src="{{ $user->line_avatar }}"
                                            alt="{{ $user->name }}">
                                    @else
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <p class="text-sm text-gray-500">
                                            @if ($user->role === 'admin')
                                                <span
                                                    class="bg-red-100 text-red-800 px-2 py-1 rounded-full text-xs">Admin</span>
                                            @elseif($user->role === 'dealer')
                                                <span
                                                    class="bg-purple-100 text-purple-800 px-2 py-1 rounded-full text-xs">Dealer</span>
                                            @else
                                                <span
                                                    class="bg-green-100 text-green-800 px-2 py-1 rounded-full text-xs">Customer</span>
                                            @endif
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">
                                        @if ($promotion->is_active)
                                            <span
                                                class="bg-green-100 text-green-800 px-2 py-1 rounded-full text-xs">เปิดใช้งาน</span>
                                        @else
                                            <span
                                                class="bg-gray-100 text-gray-800 px-2 py-1 rounded-full text-xs">ปิดใช้งาน</span>
                                        @endif
                                    </p>
                                </div>
