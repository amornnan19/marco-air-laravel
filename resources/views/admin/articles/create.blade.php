...
@section('content')
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-bold text-gray-900">เพิ่มบทความใหม่</h1>
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="excerpt" id="excerpt" rows="3"
                            ...
                            placeholder="กรอกเนื้อหาย่อสำหรับแสดงในรายการ">{{ old('excerpt') }}</textarea>
                        @error('excerpt')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" id="meta_description" rows="2"
                            ...
                            placeholder="คำอธิบายสำหรับ Search Engine (แนะนำ 150-160 ตัวอักษร)">{{ old('meta_description') }}</textarea>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="sort_order" id="sort_order"
                            value="{{ old('sort_order', $nextSortOrder) }}" min="1" required readonly
                            class="w-full border border-gray-300 rounded-md px-3 py-2 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('sort_order') border-red-300 @enderror">
                        <div class="mt-1">
                            <label class="inline-flex items-center">
                                <input type="checkbox" id="custom-sort" class="rounded border-gray-300 text-blue-600">
                                <span class="ml-2 text-sm text-gray-600">กำหนดลำดับเอง</span>
                            </label>
                        </div>
                        @error('sort_order')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            <label class="inline-flex items-center">
                                <input type="radio" name="is_published" value="1" @checked(old('is_published', '0') == '1')
                                    class="border-gray-300 text-blue-600 focus:ring-blue-500">
                                <span class="ml-2 text-sm text-gray-700">เผยแพร่ทันที</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" name="is_published" value="0" @checked(old('is_published', '0') == '0')
                                    class="border-gray-300 text-blue-600 focus:ring-blue-500">
    ...
    <script>
        ...
        // Custom sort order toggle
        document.getElementById('custom-sort').addEventListener('change', function() {
            const sortInput = document.getElementById('sort_order');
            if (this.checked) {
                sortInput.readOnly = false;
                sortInput.classList.remove('bg-gray-50');
                sortInput.focus();
            } else {
                sortInput.readOnly = true;
                sortInput.classList.add('bg-gray-50');
