    ...
    <div class="flex flex-col h-full">
        ...
        <main class="flex-1 overflow-y-auto bg-white">
            ...
            <div class="relative">
                ...
                <div class="relative h-64">
                    ...
                    @else
                        <div
                            class="absolute inset-0 bg-gradient-to-br from-{{ $service->icon_color }}-500 to-{{ $service->icon_color }}-600">
                        </div>
                    @endif
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            <div class="flex justify-between items-start mb-2">
                                ...
                                <div class="text-right ml-3">
                                    <span
                                        class="text-lg font-bold text-{{ $service->icon_color }}-600">{{ number_format($package['price']) }}
                                        บาท</span>
                    ...
                    <div class="space-y-3">
                        @foreach ($service->details as $detail)
                            <div class="flex items-start gap-3">
                                <div class="w-1.5 h-1.5 bg-{{ $service->icon_color }}-600 rounded-full mt-2 flex-shrink-0">
                                </div>
                ...
                <div class="mt-8 bg-blue-50 rounded-lg p-4">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-600">ราคา : <span
                                    class="text-red-600 font-bold">{{ $service->formatted_price_display }} / เครื่อง</span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <p class="text-xs text-blue-700">สอบถามรายละเอียดเพิ่มเติมได้ที่โทร.
                            {{ $service->contact_phone ?? '02-888-8888' }}</p>
                    </div>
                </div>
            </div>
        </main>
        ...
        <div class="bg-white border-t p-4">
            <a href="{{ route('service.order', $service->slug) }}"
                class="block w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white font-bold py-3 px-4 rounded-lg text-center">
                สนใจบริการ
            </a>
        </div>
    </div>
