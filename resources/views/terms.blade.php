...
<head>
    ...
    <title>Terms & Conditions - Marco Air</title>
        ...
        <div class="w-full max-w-sm mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                <div class="text-sm text-gray-700 leading-relaxed space-y-4">
                    ...
                    <p>
                        การใช้งานบริการจะถือว่าท่านยอมรับใน<a href="{{ route('terms.conditions') }}" target="_blank" class="text-blue-600 underline">ข้อกำหนดและเงื่อนไข</a> และยินยอมรับข่าวสารจากบริษัท 
                        มาร์โกแอร์ จำกัด ซึ่งท่านสามารถยกเลิกได้ตามต้องการ
                    </p>
                    
                    <p class="text-xs text-gray-500 pt-2">
                        อ่านเพิ่มเติม: 
                        <a href="{{ route('privacy.policy') }}" target="_blank" class="text-blue-600 underline">นโยบายความเป็นส่วนตัว</a> | 
                        <a href="{{ route('cookie.policy') }}" target="_blank" class="text-blue-600 underline">นโยบายการใช้คุกกี้</a>
                    </p>
                </div>
            </div>
                ...
                <form action="{{ route('terms.accept') }}" method="POST" class="space-y-4">
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <label for="marketing_consent" class="text-sm text-gray-700 leading-relaxed">
                            <span class="text-red-500">*</span> ข้าพเจ้ายินยอมรับข่าวสารและสิทธิประโยชน์ ผ่านทางอีเมล, เอสเอ็มเอส, แอปพลิเคชั่น, โซเชียลมิเดีย, โทรศัพท์ และไดเร็กเมลจากบริษัท มาร์โกแอร์ จำกัด
                        </label>
                    </div>
