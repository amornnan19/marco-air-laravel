...
<head>
    ...
    <title>ข้อกำหนดและเงื่อนไข - Marco Air</title>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                <div class="text-sm text-gray-700 leading-relaxed space-y-4">
                    <section>
                        ...
                        <p>การใช้บริการของ Marco Air หมายถึงการยอมรับข้อกำหนดและเงื่อนไขเหล่านี้ทั้งหมด หากท่านไม่ยอมรับข้อกำหนดเหล่านี้ กรุณาอย่าใช้บริการของเรา</p>
                    </section>

                    <section>
                        <h2 class="font-semibold text-gray-900 mb-2">2. การใช้บริการ</h2>
                        <p>ท่านสามารถใช้บริการของเราเพื่อวัตถุประสงค์ที่ถูกต้องตามกฎหมายเท่านั้น ห้ามใช้บริการในทางที่ผิดกฎหมายหรือละเมิดสิทธิของผู้อื่น</p>
                    </section>

                    <section>
                        <h2 class="font-semibold text-gray-900 mb-2">3. ข้อมูลส่วนบุคคล</h2>
                        <p>เราจะเก็บรักษาข้อมูลส่วนบุคคลของท่านตามนโยบายความเป็นส่วนตัวของเรา ข้อมูลจะถูกใช้เพื่อพัฒนาบริการและการติดต่อสื่อสารกับท่าน</p>
                    </section>
