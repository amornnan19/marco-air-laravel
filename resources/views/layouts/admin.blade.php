                ...
                <div class="flex items-center">
                    ...
                    <nav class="hidden md:ml-6 md:flex md:space-x-8">
                        ...
                        <a href="{{ route('admin.articles.index') }}"
                            class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium
                                  @if (request()->routeIs('admin.articles.*')) text-blue-600 border-blue-600 
                                  @else 
                                      text-gray-500 border-transparent hover:text-gray-700 hover:border-gray-300 @endif">
                            บทความ
                        </a>
                        <a href="{{ route('admin.products.index') }}"
                            class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium
                                  @if (request()->routeIs('admin.products.*')) text-blue-600 border-blue-600 
                                  @else 
                                      text-gray-500 border-transparent hover:text-gray-700 hover:border-gray-300 @endif">
                            สินค้า
                        </a>
                        <a href="{{ route('admin.services.index') }}"
                            class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium
                                  @if (request()->routeIs('admin.services.*')) text-blue-600 border-blue-600 
                                  @else 
                                      text-gray-500 border-transparent hover:text-gray-700 hover:border-gray-300 @endif">
                            บริการ
                        </a>
